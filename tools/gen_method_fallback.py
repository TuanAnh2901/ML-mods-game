...
DESIRED: list[tuple[Any, ...]] = [
    ...
    ("AutoChess.DataClasses.UserData.ItemModule",
                                "IsEnoughResource",    "Assembly-CSharp",      None,       2),
    ...
    # Pass runtime observers/modifiers.
    ("AutoChess.BattlePass.BattlePassController", "get_IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.BattlePass.BattlePassController", "get_Level", "Assembly-CSharp", None, 0),
    ("AutoChess.BattlePass.BattlePassController", "get_MaxLevel", "Assembly-CSharp", None, 0),
    ("AutoChess.BattlePass.BattlePassHandler", "get_IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.BattlePass.BattlePassServerUserData", "get_IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.BattlePass.BattlePassServerUserData", "get_BattlePassLevel", "Assembly-CSharp", None, 0),
    ("PnkClient.ServerUpdateHandler", "SyncBattlePassPoints", "Assembly-CSharp", None, 3),
    ("PlayfulStatisticsRequestsHandler", "SendBattlePassProgress", "Assembly-CSharp", None, 6),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.EventsPassMiniEventModule", "IsPremium", "Assembly-CSharp", None, 1),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.EventsPassMiniEventModule", "SendStatisticsProgress", "Assembly-CSharp", None, 3),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Data.EventsPassMiniEventData", "get_IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Data.EventsPassMiniEventData", "get_Level", "Assembly-CSharp", None, 0),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Data.EventsPassMiniEventData", "get_EventPassProgress", "Assembly-CSharp", None, 0),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Visual.EventPassPremiumController", "get_IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Visual.EventPassPremiumController", "get_Level", "Assembly-CSharp", None, 0),
    ("AutoChess.MiniEvents.MiniEventModules.EventsPass.Visual.EventPassPremiumController", "get_MaxLevel", "Assembly-CSharp", None, 0),
    ("PnkClient.Core.PnkHandler", "CheckShowErrorWindow", "Assembly-CSharp", None, 5),
    ("PnkClient.Core.PnkHandler", "HandleError", "Assembly-CSharp", None, 1),
    ("UI_Scripts.WindowManager.NetworkErrorWindow", "ShowError", "Assembly-CSharp", None, 1),
    ("PnkClient.Core.PnkError", ".ctor", "Assembly-CSharp", None, 3, "System.Int64 errorCode"),
    ("PnkClient.ServerUpdateHandler", "SyncEventPass", "Assembly-CSharp", None, 3),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyController", "IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyController", "GetCurrentProgress", "Assembly-CSharp", None, 0),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyController", "GetMaxProgress", "Assembly-CSharp", None, 0),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyController", "UpdateProgress", "Assembly-CSharp", None, 1),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyUserDataManager", "IsPremium", "Assembly-CSharp", None, 0),
    ("AutoChess.Journey.JourneyModuleABC.Trophy.TrophyUserDataManager", "CurrentProgress", "Assembly-CSharp", None, 0),
    ...
    ("AutoChess.Journey.JourneyModuleABC.Service.ExternalJourneyFighter",
                                "ClaimRewardsOnWin", "Assembly-CSharp", None, 0),
    ...
    ("AutoChess.UIScripts.WindowScripts.BattlefieldWindow.BattlefieldWindow",
                                "get_AutoBattleController", "Assembly-CSharp", None, 0),
    # AutoBattle lifecycle hooks: the controller is created lazily and its
    # Start callback is the reliable point at which the native pointer exists.
    ("AutoChess.CoreGameplay.Fight.AutoBattle.AutoBattleController",
                                "Start", "Assembly-CSharp", None, 0),
    ("AutoChess.CoreGameplay.Fight.AutoBattle.AutoBattleController",
                                "SetAutoBattleInactive", "Assembly-CSharp", None, 0),
    ("AutoChess.CoreGameplay.Fight.AutoBattle.AutoBattleController",
                                "OnAutoBattleClicked", "Assembly-CSharp", None, 0),
    ("AutoChess.CoreGameplay.Fight.AutoBattle.AutoBattleController",
                                "IsAutoBattleActive", "Assembly-CSharp", None, 0),
    ...
    ("UI_Scripts.WindowManager.MultichestWindow",
                                "ShowMultichestWindow", "Assembly-CSharp", None, 6),
    ("UI_Scripts.WindowManager.MultichestWindow",
...
MANUAL_ALIAS_ROWS: list[dict[str, Any]] = [
    # Preserve legacy runtime entries that are absent from the current map.
    {"assembly": "Assembly-CSharp", "ns": "AutoChess.CoreGameplay.Participant",
     "cls": "ServerParticipant", "method": "get_Uid", "argc": 0, "rva": 0x5CF280},
    {"assembly": "Assembly-CSharp", "ns": "AutoChess.CoreGameplay.Participant",
     "cls": "ServerParticipant", "method": "UpdateStreaks", "argc": 1, "rva": 0xE18B00},
